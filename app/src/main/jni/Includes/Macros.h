...
#define HOOK_LIB(lib, offset, ptr, orig) hook((void *)getAbsoluteAddress(OBFUSCATE(lib), string2Offset(offset)), (void *)ptr, (void **)&orig)
...
#define PATCH_LIB_SWITCH(lib, offset, hex, boolean) patchOffset(lib, string2Offset(offset), OBFUSCATE(hex), boolean)
